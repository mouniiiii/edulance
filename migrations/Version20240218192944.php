 ...
 */
final class Version20240218192944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, id_category_id INT NOT NULL, id_creator_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, type_offre VARCHAR(255) NOT NULL, experience_level VARCHAR(255) NOT NULL, salary VARCHAR(255) NOT NULL, expiration_date DATE NOT NULL, description VARCHAR(255) NOT NULL, language JSON NOT NULL COMMENT \'(DC2Type:json)\', priority INT DEFAULT NULL, INDEX IDX_AF86866FA545015 (id_category_id), INDEX IDX_AF86866FC4A88E71 (id_creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
